...
$instance->pushHandler(${($_ = isset($this->services['monolog.handler.console_very_verbose']) ? $this->services['monolog.handler.console_very_verbose'] : $this->load(__DIR__.'/getMonolog_Handler_ConsoleVeryVerboseService.php')) && false ?: '_'});
