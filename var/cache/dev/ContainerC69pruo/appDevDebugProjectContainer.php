...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->fileMap = array(
            ...
            'monolog.handler.console_very_verbose' => __DIR__.'/getMonolog_Handler_ConsoleVeryVerboseService.php',
            ...
            'oc_platform.antispam' => __DIR__.'/getOcPlatform_AntispamService.php',
            'oc_platform.doctrine_listener.application_creation' => __DIR__.'/getOcPlatform_DoctrineListener_ApplicationCreationService.php',
            'oc_platform.email.application_mailer' => __DIR__.'/getOcPlatform_Email_ApplicationMailerService.php',
            'oc_platform.purger.advert' => __DIR__.'/getOcPlatform_Purger_AdvertService.php',
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('rZiOD8sCOe', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('JBSDTtBNcW', 0, 'V+tAIQftkbklzxsNFrg9QE', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xLqUYpAFRa', 0, 'V+tAIQftkbklzxsNFrg9QE', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wbdm7ZCYYY', 0, 'V+tAIQftkbklzxsNFrg9QE', ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('console.command', array(0 => function () {
            return ${($_ = isset($this->services['monolog.handler.console_very_verbose']) ? $this->services['monolog.handler.console_very_verbose'] : $this->load(__DIR__.'/getMonolog_Handler_ConsoleVeryVerboseService.php')) && false ?: '_'};
        }, 1 => 'onCommand'), 255);
        $instance->addListener('console.terminate', array(0 => function () {
            return ${($_ = isset($this->services['monolog.handler.console_very_verbose']) ? $this->services['monolog.handler.console_very_verbose'] : $this->load(__DIR__.'/getMonolog_Handler_ConsoleVeryVerboseService.php')) && false ?: '_'};
        }, 1 => 'onTerminate'), -255);
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'OCCoreBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'\\src\\OC\\CoreBundle'),
